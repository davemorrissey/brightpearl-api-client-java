...
public class ServiceReadRequestBuilderTest {
    ...
    public void testUniqueManualRuids() {
        ...
        ServiceReadRequestBuilder<Void> builder = ServiceReadRequestBuilder.newGetRequest(ServiceName.CONTACT, "/contact", Void.class).withRuid("a");
